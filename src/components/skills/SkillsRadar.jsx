...
export default function SkillsRadar({ skillsData, selectedSkill, setSelectedSkill, isDark }) {
            ...
            <div className="lg:col-span-2 h-96">
                <ResponsiveContainer width="100%" height="100%">
                    <RadarChart cx="50%" cy="50%" outerRadius="80%" data={skillsData}>
                        ...
                        <Radar name="Skill Level" dataKey="level" stroke="var(--primary)" fill="url(#radarGradient)" strokeWidth={2} />
